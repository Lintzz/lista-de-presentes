...
const getDomain = (url) => { try { return new URL(url).hostname.replace("www.", ""); } catch (e) { return null; } };
...
function SortableItemCard({ id, item, isOwner, user, handlers, isDragEnabled }) {
